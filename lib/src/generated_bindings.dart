...
class LibWGPU {
  ...
  LibWGPU(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;
  ...
  late final _wgpuComputePassEncoderWriteTimestampPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(WGPUComputePassEncoder, WGPUQuerySet,
              ffi.Uint32)>>('wgpuComputePassEncoderWriteTimestamp');
  late final _wgpuComputePassEncoderWriteTimestamp =
      _wgpuComputePassEncoderWriteTimestampPtr.asFunction<
          void Function(WGPUComputePassEncoder, WGPUQuerySet, int)>();
  ...
  late final _wgpuRenderPassEncoderWriteTimestampPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(WGPURenderPassEncoder, WGPUQuerySet,
              ffi.Uint32)>>('wgpuRenderPassEncoderWriteTimestamp');
  late final _wgpuRenderPassEncoderWriteTimestamp =
      _wgpuRenderPassEncoderWriteTimestampPtr.asFunction<
          void Function(WGPURenderPassEncoder, WGPUQuerySet, int)>();
...
abstract class WGPUFeatureName {
  ...
  static const int WGPUFeatureName_DepthClamping = 1;
...
abstract class WGPUPowerPreference {
  static const int WGPUPowerPreference_LowPower = 0;
  static const int WGPUPowerPreference_HighPerformance = 1;
...
abstract class WGPUSType {
  ...
  static const int WGPUSType_PrimitiveDepthClampingState = 7;
...
abstract class WGPUTextureFormat {
  ...
  static const int WGPUTextureFormat_Depth32Float = 41;
  static const int WGPUTextureFormat_BC1RGBAUnorm = 42;
  static const int WGPUTextureFormat_BC1RGBAUnormSrgb = 43;
  static const int WGPUTextureFormat_BC2RGBAUnorm = 44;
  static const int WGPUTextureFormat_BC2RGBAUnormSrgb = 45;
  static const int WGPUTextureFormat_BC3RGBAUnorm = 46;
  static const int WGPUTextureFormat_BC3RGBAUnormSrgb = 47;
  static const int WGPUTextureFormat_BC4RUnorm = 48;
  static const int WGPUTextureFormat_BC4RSnorm = 49;
  static const int WGPUTextureFormat_BC5RGUnorm = 50;
  static const int WGPUTextureFormat_BC5RGSnorm = 51;
  static const int WGPUTextureFormat_BC6HRGBUfloat = 52;
  static const int WGPUTextureFormat_BC6HRGBFloat = 53;
  static const int WGPUTextureFormat_BC7RGBAUnorm = 54;
  static const int WGPUTextureFormat_BC7RGBAUnormSrgb = 55;
...
class WGPUPrimitiveDepthClampingState extends ffi.Struct {
